...
def test_defined():
    ...
    assert ' 96% (1.87/1.95 KiB) [############## ] eta 00:01 |' == progress_bar.bar

    eta._NOW = lambda: 1411868724.0
    progress_bar.eta.set_numerator(1999)
    assert ' 99% (1.95/1.95 KiB) [############## ] eta 00:01 /' == progress_bar.bar
...
def test_defined_long():
    ...
    assert ' 65% (13/20 B) [########     ] eta 00:04 /' == progress_bar.bar
    ...
    assert ' 85% (17/20 B) [###########  ] eta 00:02 /' == progress_bar.bar
